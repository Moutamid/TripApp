...
public  class MonthEventAdapter extends RecyclerView.Adapter<MonthEventAdapter.EventViewHolder> {
   ...
   @NonNull
   @Override
   public MonthEventAdapter.EventViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
       View view = LayoutInflater.from(context).inflate(R.layout.item_event_month, parent, false);
       return new MonthEventAdapter.EventViewHolder(view);
   }

   @Override
   public void onBindViewHolder(@NonNull MonthEventAdapter.EventViewHolder holder, int position) {
