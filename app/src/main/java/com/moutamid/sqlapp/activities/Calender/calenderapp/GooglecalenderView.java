...
public class GooglecalenderView extends LinearLayout {
    ...
    public GooglecalenderView(Context context) {
        super(context);
        LayoutInflater.from(context).inflate(com.moutamid.sqlapp.R.layout.viewpagerlay, this);
    ...
    public void init(HashMap<LocalDate, EventInfo> eventhashmap, LocalDate mindate, LocalDate maxdate) {
        ...
        viewPager = findViewById(com.moutamid.sqlapp.R.id.viewpager);
...
//               }
    ...
    public void adjustheight() {
        ...
        if (myPagerAdapter != null) {
            ...
            int setheight = 75 + (context.getResources().getDimensionPixelSize(com.moutamid.sqlapp.R.dimen.itemheight) * numbercolumn) + context.getResources().getDimensionPixelSize(com.moutamid.sqlapp.R.dimen.tendp) + getStatusBarHeight();
...
//    }
    ...
    class MonthPagerAdapter extends RecyclerView.Adapter<MonthPagerAdapter.MonthViewHolder> {
        ...
        public MonthViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = mInflater.inflate(com.moutamid.sqlapp.R.layout.fraglay, parent, false);
...
//            dayadapter.notifyDataSetChanged();
        ...
        class MonthViewHolder extends RecyclerView.ViewHolder {
            ...
            MonthViewHolder(View itemView) {
                super(itemView);
                jCalendarMonthTopView = itemView.findViewById(com.moutamid.sqlapp.R.id.jcalendarmonthview);
    ...
    class Dayadapter extends RecyclerView.Adapter<Dayadapter.DayViewHolder> {
        ...
        public DayViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            View view = mInflater.inflate(com.moutamid.sqlapp.R.layout.gridlay, parent, false);
...
//                    holder.textView.setBackgroundResource(R.drawable.selectedback);
        ...
        class DayViewHolder extends RecyclerView.ViewHolder {
            ...
            public DayViewHolder(View itemView) {
                ...
                eventview = itemView.findViewById(com.moutamid.sqlapp.R.id.eventview);
