...
public class JCalendarMonthTopView extends View {
    ...
    public JCalendarMonthTopView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, com.moutamid.sqlapp.R.styleable.JCalendarMonthView, 0, 0);
        try {
            dayHeight = a.getDimensionPixelSize(com.moutamid.sqlapp.R.styleable.JCalendarMonthView_dayHeight, 200);
            daytextsize = a.getDimensionPixelSize(com.moutamid.sqlapp.R.styleable.JCalendarMonthView_daytextsize, 12);
            datetextsize = a.getDimensionPixelSize(com.moutamid.sqlapp.R.styleable.JCalendarMonthView_datetextsize, 14);
            eventtextsize = a.getDimensionPixelSize(com.moutamid.sqlapp.R.styleable.JCalendarMonthView_eventtextsize, 11);

            daytextcolor = a.getColor(com.moutamid.sqlapp.R.styleable.JCalendarMonthView_daytextcolor, Color.GRAY);
            datetextcolor = a.getColor(com.moutamid.sqlapp.R.styleable.JCalendarMonthView_datetextcolor, Color.GRAY);


            datemargintop = a.getDimensionPixelSize(com.moutamid.sqlapp.R.styleable.JCalendarMonthView_datemargintop, 25);
            linecolor = a.getColor(com.moutamid.sqlapp.R.styleable.JCalendarMonthView_linecolor, Color.WHITE);
            linewidth = a.getDimensionPixelSize(com.moutamid.sqlapp.R.styleable.JCalendarMonthView_linewidth, 2);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int setheight = (mContext.getResources().getDimensionPixelSize(com.moutamid.sqlapp.R.dimen.itemheight) * numberofrow) + dayHeight + datemargintop;
        ...
        mHeaderTextPaint.setTypeface(ResourcesCompat.getFont(mContext, com.moutamid.sqlapp.R.font.googlesansmed));
        ...
        jDateTextPaint.setTypeface(ResourcesCompat.getFont(mContext, com.moutamid.sqlapp.R.font.latoregular));
        ...
        jeventtextpaint.setTypeface(ResourcesCompat.getFont(mContext, com.moutamid.sqlapp.R.font.googlesansmed));
        ...
        jtodaypaint.setColor(getResources().getColor(com.moutamid.sqlapp.R.color.lightblack));
            ...
            for (int j = 0; j < 7; j++) {
                ...
                if (position >= firstday) {
                    ...
                    if (dayModel.isToday() || selected) {//istoday
                        ...
                        float max = getResources().getDimensionPixelSize(com.moutamid.sqlapp.R.dimen.circlesize);

                        if (dayModel.isToday()) {
                            jtodaypaint.setColor(getResources().getColor(com.moutamid.sqlapp.R.color.selectday));
                    ...
                    if (dayModel.getEventlist() && !selected) {//event day
                        jtodaypaint.setColor(getResources().getColor(com.moutamid.sqlapp.R.color.event_color_04));
                        float centerx = ((eachcellwidth * j) + eachcellwidth / 2.0f);
