...
public class JCalendarMonthView extends View {
    ...
    public JCalendarMonthView(final Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            ...
            linecolor = a.getColor(com.moutamid.sqlapp.R.styleable.JCalendarMonthView_linecolor, Color.GRAY);
            ...
            for (int j = 0; j < 7 && i < 6; j++) {
                ...
                if (i == 0) {
                    if (j == currentdaynameindex)
                        mHeaderTextPaint.setColor(getResources().getColor(com.moutamid.sqlapp.R.color.selectday));//todaycolor
